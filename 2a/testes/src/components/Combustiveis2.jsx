...
function Combustiveis2() {
  ...
  return (
    <div className='container'>  
        ...
        <div>Total Álcool: {totalAlcool}</div>
        <div>Total Gasolina: {totalGasolina}</div>
        <div>Total Diesel: {totalDiesel}</div>
    </div>
  )
}
export default Combustiveis2
